...
for w in range(1):
    ...
    plt.savefig("shap_composite_2_NADW_"+str(w)+".png")
    ...
    #plt.ylabel('feature',fontsize=13)
    #plt.xlabel('composite_shap',fontsize=13)
    plt.savefig("shap_composite_8_NADW_"+str(w)+".png")
...
for w in range(1):
    ...
    #plt.ylabel('feature',fontsize=13)
    #plt.xlabel('composite_shap',fontsize=13)
    plt.savefig("shap_composite_2_NADW_time_"+str(w)+".png")
...
for w in range(1):
    ...
    #plt.ylabel('feature',fontsize=13)
    #plt.xlabel('composite_shap',fontsize=13)
    plt.savefig("shap_composite_8_NADW_time_"+str(w)+".png")
