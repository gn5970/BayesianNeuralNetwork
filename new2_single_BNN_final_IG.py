    ...
    for N in range(264):
       if N==0:
         if w ==0:
            ...
            constant=1
            num_steps=200
            #baseline_2equence = torch.full(x_test.size(), constant, device=x_test.device)
...
for w in range(1):
    ...
    plt.savefig("ig_composite_2_LCDW_"+str(w)+".png")
...
for w in range(1):
    ...
    #plt.ylabel('feature',fontsize=13)
    #plt.xlabel('composite_shap',fontsize=13)
    plt.savefig("ig_composite_8_LCDW_"+str(w)+".png")
...
for w in range(1):
    ...
    #plt.ylabel('feature',fontsize=13)
    #plt.xlabel('composite_shap',fontsize=13)
    plt.savefig("ig_composite_2_NADW_time_"+str(w)+".png")
    w=1
    plt.figure()
    plt.subplot(2,1,1)
    ...
    #plt.ylabel('feature',fontsize=13)
    #plt.xlabel('composite_shap',fontsize=13)
    plt.savefig("ig_composite_8_LCDW_time_"+str(w)+".png")
...
for w in range(1):
    ...
    plt.savefig('skill_total_NADW_'+str(w)+'.png')
