...
for w in range(1):
    ...
    plt.savefig("ig_composite_2_LCDW_time_total_"+str(w)+".png")
...
for w in range(1):
    ...
    # Set y-axis to log scale
    plt.xlabel('Time',fontsize=11)
    plt.savefig("ig_composite_8_LCDW_time_total_"+str(w)+".png")
...
plt.xticks([r + barWidth for r in range(len(IG))],
        ['PT', 'Salinity', 'EKE', 'N'])
plt.legend()
plt.savefig("XAI_composite_2_LCDW_0.png")
...
plt.xticks([r + barWidth for r in range(len(IG))],
        ['PT', 'Salinity', 'EKE', 'N'])
plt.legend()
plt.savefig("XAI_composite_8_LCDW_0.png")
