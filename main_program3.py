...
for w in range(1):
    ...
    plt.savefig("ig_composite_2_UCDW_time_total_"+str(w)+".png")
...
for w in range(1):
    ...
    # Set y-axis to log scale
    plt.xlabel('Time',fontsize=11)
    plt.savefig("ig_composite_8_UCDW_time_total_"+str(w)+".png")
...
#shap.summary_plot(A_mean_baseline1,feature_names=feature,plot_type="auto")
plt.ylabel('Explainability',fontsize=13)
# Set y-axis to log scale
plt.xlabel('Input feature',fontsize=13)
#plt.ylabel('feature',fontsize=13)
#plt.xlabel('composite_shap',fontsize=13)
plt.xticks([r + barWidth for r in range(len(IG))],
        ['PT', 'Salinity', 'EKE', 'N'])
plt.legend()
plt.savefig("XAI_composite_2_UCDW_0.png")
...
plt.xticks([r + barWidth for r in range(len(IG))],
        ['PT', 'Salinity', 'EKE', 'N'])
plt.legend()
plt.savefig("XAI_composite_8_UCDW_0.png")
